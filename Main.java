...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // I'm inputting a few of the integer along with their coralating questions so I
    // can get all of the information that I will need
    ...
    double costPerPizza = ammountOfPizza * .99;
    double labour = ammountOfPizza * .75;
    double subtotal = labour + diameter_cost + costPerPizza;
    double tax = subtotal * .13;
    double total = subtotal + tax;
    // The next section is for determaning the cost of the order based off of the
    // size, ammount, and tax.
    if (diameter < 20) {
